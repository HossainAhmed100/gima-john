...
function Cart({cart, handleRemove}){
  ...
  return (
    ...
    <h5 className='border-b mt-2  flex items-center justify-between'>Total Price : <span>${num(total)}</span></h5>   
    <h5 className='border-b mt-2  flex items-center justify-between'>Tax : <span>${num(tax)}</span></h5>   
    <h5 className='border-b mt-2  flex items-center justify-between'>Total Shipping Charge : <span>${num(shippingCharge)}</span></h5>   
    <h5 className='border-b mt-2  flex items-center justify-between'>Grand Total : <span>${num(grandTotal)}</span></h5>  
    </div>  
