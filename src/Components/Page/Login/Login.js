      ...
      <div className="max-w-lg mx-auto my-10 bg-white p-8 rounded-xl shadow shadow-slate-300">
        ...
        <form onSubmit={handleFormSubmit} className="my-10">
            <div className="flex flex-col space-y-5">
                ...
                <p className="text-center">Not registered yet? <NavLink to="/signup" className="text-indigo-600 font-medium inline-flex space-x-1 items-center"><span>Register now </span><span>
                  <BsBoxArrowUpRight />
                  </span></NavLink></p>
            </div>
        </form>
